...
class BoardServiceTest {
    ...
    void getBoardList_success_noSearch() {
        // given
        BoardSearchReqeust request = new BoardSearchReqeust(BoardCategory.LESSON, 1, 0, 1, null, null);
        ...
        given(boardMapper.getBoardList(any(BoardSearchReqeust.class))).willReturn(boards);
        ...
        verify(boardMapper).getBoardList(any(BoardSearchReqeust.class));
    }
    ...
    void getBoardList_success_titleSearch() {
        // given
        BoardSearchReqeust request = new BoardSearchReqeust(BoardCategory.DIET, 10, 0, 1, BoardSearchCategory.TITLE, "운동");
        List<Board> boards = List.of(
    ...
    void getBoardList_fail_invalidPageNum() {
        // given
        BoardSearchReqeust request = new BoardSearchReqeust(BoardCategory.LESSON, 10, 0, 0, null, null);

        // when & then
        assertThatThrownBy(() -> boardService.getBoardList(request))
